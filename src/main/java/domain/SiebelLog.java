...
class SiebelLog {
	private static ArrayList<String> keyList = new ArrayList<>(); //Тут хранятся бинды, на место которых надо поставить значения
	private static Hashtable tableKeyValue = new Hashtable();
	private static String siebelStringTotal;
	...
	private static String replaceBinds(String siebelString) {
		try {
	...
	private static void getKeyValueMap(String siebelString) {
	...
	private static void getKeyList(String siebelString) {
